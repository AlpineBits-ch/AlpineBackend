...
public class BackupControllerTests
{
    ...
    /// <summary>Stands in for the client-derived value.</summary>
    ...
    /// <summary>Seeds the envelope directly.</summary>
    ...
    /// <summary>The original C2: a session on one device reading another device's blob.</summary>
    [Test]
    ...
    /// <summary>Writes are bound too.</summary>
    [Test]
    ...
    /// <summary>A revoked session must not keep acting as its device.</summary>
    [Test]
    ...
    /// <summary>The claim hands over a wrapped signing key.</summary>
    [Test]
    ...
    /// <summary>The source is the session's device, never a header.</summary>
    [Test]
    ...
    {
        await SeedUser();
        // The two disagree, which only happens on an account mid-retrofit.
    ...
    /// <summary>The honesty case, and the one that made §L.8 worth reopening.</summary>
    [Test]
    ...
    /// <summary>Trust on first use, so the gap above closes itself.</summary>
    [Test]
    ...
    /// <summary>Once stored it is immutable at a version.</summary>
    [Test]
    ...
    /// <summary>§L.8's other half.</summary>
    [Test]
    ...
    /// <summary>A lower version is not a rotation, it is a client holding stale state.</summary>
    [Test]
