...
/// <summary>
/// The gate that decides whether a message is a candidate for link previews at all. This runs on
/// every message posted on the instance, and a false positive turns into an outbound HTTP request.
/// </summary>
[TestFixture]
