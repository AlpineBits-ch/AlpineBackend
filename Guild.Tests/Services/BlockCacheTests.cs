...
/// <summary>
/// Covers <see cref="BlockCache"/> and the <see cref="BlockView"/> it hands out.
///
/// <para>Two properties matter beyond "does it read the list". First, one resolved user answers
/// every pair they are in - that is what lets a fan-out cost a single lookup instead of one per
/// recipient. Second, an unresolvable pair is reported blocked; a block that stops applying because
/// Social hiccuped is a block that does not exist.</para>
/// </summary>
[TestFixture]
