...
/// <summary>
/// Covers AttachmentController's non-S3 paths: attachment metadata lookup, the not-found guards on
/// download/thumbnail (which return before ever touching IAmazonS3), and the cache-hit fast path on
/// download/thumbnail (which also never touches S3).
/// </summary>
[TestFixture]
