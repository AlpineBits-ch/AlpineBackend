    ...
    ILogger<HouseholdReconcileService> logger) : BackgroundService
{
    ...
    /// <summary>How long a lapsed guest membership is kept before deletion. Not zero, so the
    /// audit trail of "this person had access until Tuesday" survives a little while.</summary>
