...
public class SharedGuildDirectMessageLookupTests
{
    ...
    /// preference per guild for the recipient. A pair with nothing in common is omitted from the
    /// first answer, matching the contract.
    /// </summary>
    ...
    {
        // Both halves matter. The recipient's consent is the one being checked, and narrowing the
        // id list to the intersection is what keeps a complete guild-membership list for either
        // party out of this service - see the remarks on SharedGuildDirectMessageLookup.
