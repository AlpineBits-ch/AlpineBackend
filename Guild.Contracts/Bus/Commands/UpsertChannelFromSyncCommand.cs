...
/// <summary>
/// Applies a single Discord CHANNEL_CREATE/CHANNEL_UPDATE dispatch (categories included - they
/// are just type:4 channels in Discord's own model) to an already-linked/imported guild.
/// One command per event, unlike the bulk <see cref="ImportGuildStructureCommand"/>, since sync
/// events arrive one at a time over the Import service's Gateway connection.
/// </summary>
