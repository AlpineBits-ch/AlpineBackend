...
/// condition), Leave's alone-timeout/all-left transitions, End/Timeout/EndIfStillAlone. This
/// entity sat at 33% real coverage despite being entirely infrastructure-free - the Application-
/// layer handler tests elsewhere in this suite only ever exercise it indirectly via
/// JsonSerializer round-trips through the cache, never its actual state-transition methods.
/// </summary>
[TestFixture]
