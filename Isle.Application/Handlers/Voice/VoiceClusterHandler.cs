...
public static class VoiceClusterHandler
{
    ...
    // /voice/leave and the game-leave ingestion. Previously this handler bound the unrelated
    // domain RemovePlayer type, so leaving never updated the cluster and left the player as a
    // permanent ghost until server restart.
