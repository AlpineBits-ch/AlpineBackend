...
{
    /// <inheritdoc />
    public partial class AddGuildAuditLog : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    action_type = table.Column<AuditActionType>(type: "audit_action_type", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_audit_log_entries_guilds_guild_id",
                        column: x => x.guild_id,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_audit_log_entries_guild_id_created_at",
