...
/// <summary>
/// Set of game-connected playerIds. Reads are served from an in-memory cache; Redis is the durable
/// source of truth so presence survives an API restart. Each entry carries a sliding 2h TTL that the
/// reconcile loop refreshes for players the game roster confirms are still online — so a missed
/// disconnect event is evicted within the window rather than lingering forever.
/// </summary>
