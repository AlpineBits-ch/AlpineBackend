...
/// <summary>
/// Packs/unpacks the Discord-compat bot token: base64(client_id:client_secret). Structurally
/// just HTTP-Basic-style credential packing - the value a migrated Discord bot puts in its
/// `Authorization: Bot &lt;token&gt;` header, unpacked by <see cref="DiscordBotTokenTranslationMiddleware"/>.
/// </summary>
