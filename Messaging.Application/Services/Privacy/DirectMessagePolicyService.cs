...
/// <summary>The machine-readable half of a refusal.</summary>
public sealed record DmRefusal(string Code, string? UserId)
{
    /// <summary>The caller blocked this person.</summary>
    public const string Blocked = "blocked";

    /// <summary>The recipient does not accept this DM.</summary>
    public const string RecipientPolicy = "recipient_dm_policy";

    /// <summary>Neither the cache nor the owning service could answer.</summary>
    ...
    ILogger<DirectMessagePolicyService> logger)
{
        ...
        CancellationToken ct = default)
    {
        ...
        foreach (var target in targets)
        {
            ...
            // Someone else's action, and one the caller must not be able to detect.
    ...
    /// <summary>
    /// Whether <paramref name="initiatorUserId"/> is an accepted friend of the recipient.
    /// </summary>
