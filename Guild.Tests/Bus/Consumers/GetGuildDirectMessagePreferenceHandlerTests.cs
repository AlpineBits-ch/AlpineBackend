...
/// <summary>
/// Covers <see cref="GetGuildDirectMessagePreferenceHandler"/> - the contract Messaging resolves
/// the <c>FriendsAndServerMembers</c> DM branch against (privacy spec T0-2 / T2-14).
/// </summary>
[TestFixture]
