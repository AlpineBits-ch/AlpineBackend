...
{
    /// <inheritdoc />
    public partial class AddGuildScheduledEvents : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    status = table.Column<GuildScheduledEventStatus>(type: "guild_scheduled_event_status", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_guild_scheduled_events_channels_voice_channel_id",
            ...
            migrationBuilder.CreateTable(
                name: "guild_scheduled_event_interests",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_guild_scheduled_event_interests", x => new { x.event_id, x.user_id });
                    table.ForeignKey(
                        name: "fk_guild_scheduled_event_interests_guild_scheduled_events_even",
                        column: x => x.event_id,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_guild_scheduled_events_guild_id_starts_at",
                table: "guild_scheduled_events",
                columns: new[] { "guild_id", "starts_at" });

            migrationBuilder.CreateIndex(
                name: "ix_guild_scheduled_events_voice_channel_id",
                table: "guild_scheduled_events",
