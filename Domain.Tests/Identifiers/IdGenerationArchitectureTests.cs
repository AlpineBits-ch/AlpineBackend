...
/// <summary>Guards the invariant that there is exactly one way to mint an id.</summary>
[TestFixture]
public class IdGenerationArchitectureTests
{
    /// <summary>The project allowed to see the id implementation.</summary>
    private const string GeneratorProject = "Ids";

    /// <summary>The NuGet package backing <see cref="Identifier"/>.</summary>
    ...
    public void The_id_package_is_referenced_with_PrivateAssets_so_it_cannot_leak_to_consumers()
    {
        ...
        // This attribute is the entire enforcement mechanism.
    ...
    /// <summary>
    /// Every project in the repository that declares a PackageReference to <paramref
    /// name="packageId"/>, read from the .csproj files themselves.
    /// </summary>
    ...
    private static IEnumerable<string> ProjectFiles()
    {
        ...
        return Directory
            ...
            // .claude/worktrees holds complete checkouts of this repository.
