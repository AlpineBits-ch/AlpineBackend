...
public static class BlockQueries
{
    ...
    /// <summary>Both directions in one round trip.</summary>
    ...
    /// <summary>
    /// Every profile id in <paramref name="otherProfileIds"/> that is on either side of a block
    /// with <paramref name="viewerProfileId"/>.
    /// </summary>
