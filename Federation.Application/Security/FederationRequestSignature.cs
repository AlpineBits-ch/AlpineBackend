...
/// <summary>
/// Proof-of-possession for federation GET requests, which carry no signed body of their own the way
/// event delivery does.
/// </summary>
public static class FederationRequestSignature
{
    ...
    /// <summary>Produces the three headers a caller must send.</summary>
    ...
    /// <summary>Verifies a signed request.</summary>
