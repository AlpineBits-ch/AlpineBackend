...
{
    /// <inheritdoc />
    public partial class AddGuildOnboarding : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "guild_onboarding_configs",
                columns: table => new
                {
                    guild_id = table.Column<string>(type: "text", nullable: false),
                    enabled = table.Column<bool>(type: "boolean", nullable: false),
                    rules_text = table.Column<string>(type: "text", nullable: true),
                    default_channel_ids = table.Column<List<string>>(type: "text[]", nullable: false),
                    updated_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_guild_onboarding_configs", x => x.guild_id);
                    table.ForeignKey(
                        name: "fk_guild_onboarding_configs_guilds_guild_id",
                        column: x => x.guild_id,
