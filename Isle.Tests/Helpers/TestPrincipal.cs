...
/// NameIdentifier claim endpoints read via <c>user.FindFirstValue(ClaimTypes.NameIdentifier)</c>.
/// Same convention as Guild.Tests/Helpers/TestPrincipal.cs.</summary>
