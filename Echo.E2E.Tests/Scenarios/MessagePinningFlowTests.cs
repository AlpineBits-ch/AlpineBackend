...
/// <summary>
/// Proves message pinning end to end through the real Guild + Messaging services: a guild channel
/// message can be pinned (checking the real cross-service PinMessages permission check that
/// round-trips through Guild's HasUserPermissionToChannelHandler), shows up in the pinned-messages
/// list, and disappears again after unpinning.
/// </summary>
[TestFixture]
[Category("E2E")]
