...
/// <summary>
/// Per-player, per-command cooldown tracking backed by the distributed cache. Base scaffolding: a
/// command opts in by returning a non-zero <c>Cooldown</c>, and the command controller enforces it.
/// </summary>
