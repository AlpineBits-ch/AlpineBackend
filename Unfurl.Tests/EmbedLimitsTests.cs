...
/// <summary>
/// The size caps, and the generated/authored split they interact with.
///
/// <para>These are the only thing standing between a hostile page and unbounded message rows: an
/// unfurled embed's text is chosen by whoever controls the page it came from.</para>
/// </summary>
