...
/// participants who hadn't answered. Every path that can end a call (decline, explicit end,
/// ring timeout, all-participants-left, alone timeout) needs the exact same sequence here.
/// </summary>
