...
/// on what it returned. Needed for the rate limiter, where "operators can see the rejection" is
/// part of the requirement and is not observable from the HTTP response.
/// </summary>
