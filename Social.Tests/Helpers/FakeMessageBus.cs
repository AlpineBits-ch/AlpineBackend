...
/// convention (see Guild.Tests.Helpers.FakeMessageBus). InvokeAsync&lt;T&gt; returns a
/// pre-registered response keyed by the request's runtime type, since Social.Contracts'
/// ProfileService uses request/response bus calls (InvokeAsync), not fire-and-forget publish.
/// </summary>
