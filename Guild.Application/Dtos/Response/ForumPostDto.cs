...
/// <summary>
/// A forum post - the same Channel row a ChannelDto describes, plus the forum-specific state.
/// </summary>
...
public class ForumPostPageDto
{
    ...
    /// <summary>Opaque keyset cursor for the next page, or null at the end.</summary>
