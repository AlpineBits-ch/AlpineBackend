...
namespace Messaging.Infrastructure.Migrations
{
    ...
    public partial class AddMlsCommitTransportAndWelcomeAck : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // stranding every Welcome that is in flight across the deploy. Conversation-scoped is
            // the only kind that exists at this point - channel groups have no rows yet.
