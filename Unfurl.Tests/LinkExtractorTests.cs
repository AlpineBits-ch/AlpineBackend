...
/// <summary>
/// What gets a preview and what does not. This is the first gate in the whole feature: a URL that
/// gets past here becomes an outbound HTTP request from the server, so the negative cases matter
...
public class LinkExtractorTests
{
    ...
    public void Extract_UrlsDifferingOnlyByFragment_AreOneUrl()
    {
        ...
        // Treating them as distinct would double the fetches and split the cache for nothing.
    ...
    {
        // <https://…> is the sender saying "link it, do not unfurl it". Discord honours the same
        // syntax and people use it deliberately to keep a card out of a channel.
    ...
    {
        // An MLS-encrypted body is not valid UTF-8. It must produce no links rather than throwing:
        // this runs on the create path for every message on the instance.
