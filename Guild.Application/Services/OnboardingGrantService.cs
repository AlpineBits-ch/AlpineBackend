...
public class OnboardingGrantService(MicroserviceContext ctx, OnboardingValidationService validation)
{
    ...
    /// newly selected, revokes what is no longer selected, leaves the rest alone.
    /// </summary>
    ...
    private async Task GrantAsync(string guildId, GuildMember member, List<string> optionIds)
    {
        ...
        // (see GuildPermissionService.ApplyOverwrites), so there must never be two.
        ...
        // What onboarding already owns for this member.
