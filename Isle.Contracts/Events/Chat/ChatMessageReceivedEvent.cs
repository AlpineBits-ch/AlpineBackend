...
/// ingestion service. Everything that reacts to in-game chat (command dispatch, logging, future
/// moderation) subscribes to this instead of opening its own SSE connection to the bridge.
/// </summary>
