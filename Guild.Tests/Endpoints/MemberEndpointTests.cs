...
public class MemberEndpointTests
{
    ...
    // ══════════════════════════════════════════════════════════════════════
    // MuteMemberAsync / UnmuteMemberAsync
    // ══════════════════════════════════════════════════════════════════════
    ...
    // ══════════════════════════════════════════════════════════════════════
    // Removal must drop the cached permission set
    // ══════════════════════════════════════════════════════════════════════
    //
    // ComputePermissionsForUserAsync returns the cached blob before it re-reads membership, so a
    // removed member whose cache entry survives keeps their channel permissions for the rest of the
    // 15-minute TTL - while the direct GuildMembers.AnyAsync checks elsewhere already reject them.
