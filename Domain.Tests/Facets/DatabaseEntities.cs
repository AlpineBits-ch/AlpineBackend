...
/// <summary>
/// The set of CLR types EF Core maps as entities, taken from the real EF model of every <see
/// cref="DbContext"/> in the repository.
/// </summary>
        ...
        foreach (var contextType in contexts)
        {
            ...
            using (context)
            {
                try
                {
                    ...
                    {
                        // Owned types are value objects stored inline with their owner.
