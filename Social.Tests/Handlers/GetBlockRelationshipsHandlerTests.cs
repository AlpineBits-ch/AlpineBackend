...
/// <summary>
/// The cross-service half of blocking (privacy spec T0-3). Messaging, Guild and Federation all
/// enforce blocks off this one answer, so the properties asserted here - both directions in one
/// round trip, and nothing but genuine blocks - are what every other service's enforcement rests on.
/// </summary>
[TestFixture]
