...
/// <summary>One member's share of the household workload over the balance window. Negative
/// <see cref="BalanceMinutes"/> means they're carrying less than their share.</summary>
...
public class LedgerBalanceDto
{
    ...
    /// <summary>Positive = the house owes them, negative = they owe the house. Across all members
    /// these always sum to exactly zero.</summary>
...
public class DecisionDto
{
    ...
    /// <summary>Every block cast, with its reason. Surfaced separately from the option tallies
    /// because a block is an objection to be resolved, not a vote to be counted.</summary>
