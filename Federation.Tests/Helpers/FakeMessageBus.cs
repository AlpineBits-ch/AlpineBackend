...
/// Import.Tests/Helpers/FakeSyncMessageBus.cs). Records everything published/invoked so tests can
/// assert on it, and returns a canned GetChannelResponse (settable per test) for the one
/// InvokeAsync overload MessagingOutboundHandlers actually calls.
/// </summary>
