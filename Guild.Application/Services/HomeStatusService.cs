...
/// <summary>Ambient "who's home", stored in Redis with a TTL.
///
/// Deliberately not called presence: <see cref="GuildHydrateService"/>'s presence already means
/// online/offline, and conflating "Anna's app is connected" with "Anna is in the flat" would be a
/// permanent source of confusion.
///
/// Redis rather than Postgres because the useful property is that it <b>decays</b>. A status
/// nobody clears should quietly stop being asserted rather than claim someone is asleep three days
/// later - the value of the board depends on it being trustworthy, and a stale board is worse than
/// no board.</summary>
