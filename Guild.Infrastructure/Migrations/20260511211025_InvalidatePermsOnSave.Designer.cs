...
namespace Guild.Persistence.Migrations
{
    ...
    [Migration("20260511211025_InvalidatePermsOnSave")]
    partial class InvalidatePermsOnSave
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "member_type", new[] { "admin", "default", "moderator", "owner" });
            ...
            modelBuilder.Entity("Guild.Domain.Entity.ChannelPermission", b =>
                {
                    ...
                    b.HasIndex("CategoryId")
                        .HasDatabaseName("ix_channel_permissions_category_id");

                    b.HasIndex("ChannelId")
                        .HasDatabaseName("ix_channel_permissions_channel_id");

                    b.HasIndex("MemberId")
                        .HasDatabaseName("ix_channel_permissions_member_id");

                    b.HasIndex("RoleId")
                        .HasDatabaseName("ix_channel_permissions_role_id");
