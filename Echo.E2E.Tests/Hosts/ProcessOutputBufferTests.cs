...
/// assertion in <c>E2EUsers.RegisterAndGetTokenAsync</c> died with <c>ArgumentOutOfRangeException
/// (chunkLength)</c> out of <see cref="System.Text.StringBuilder"/> while the harness composed its
/// (unused) failure message.
/// </summary>
[TestFixture]
