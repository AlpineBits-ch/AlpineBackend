...
/// <summary>URL in, embed out.</summary>
    ...
    private async Task<EmbedPayload> BuildAsync(Uri uri, string originalUrl, CancellationToken ct)
    {
        ...
        if (imageUrl is not null)
        {
            ...
            if (processed is not null)
            {
                ...
                // article's hero image is a full-width image.
        ...
        // The single place a player may be attached, and only from the registry's whitelist.
