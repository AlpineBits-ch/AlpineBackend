...
/// <summary>
/// Bots' participant in the export fan-out (T1-7).
///
/// <para>A developer asking what this platform holds about them expects their applications in the
/// answer. What they must not get is somebody else's: the negative tests cover another owner's
/// application, and the identity of whoever installed the subject's bot into their own server.</para>
/// </summary>
[TestFixture]
