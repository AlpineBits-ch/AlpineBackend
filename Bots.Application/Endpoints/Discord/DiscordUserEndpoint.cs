...
/// <summary>
/// Discord-compat REST surface: parse a Discord-shaped request, translate to the existing
/// internal Wolverine bus command/query on the owning service's *.Contracts, map the internal
/// response to a Discord-shaped response. No business logic belongs in this namespace - it's
/// a translation layer in front of handlers that already exist for the native /api/v1 surface.
/// </summary>
[Authorize]
