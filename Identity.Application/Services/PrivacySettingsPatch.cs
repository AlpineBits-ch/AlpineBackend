...
/// <summary>Applies a partial update to a <see cref="UserPrivacySettings"/> row.</summary>
public static class PrivacySettingsPatch
{
    /// <summary>An upper bound on a user-set DM retention window.</summary>
    public const int MaxDmRetentionDays = 3650;

    /// <summary>The outcome of applying a patch.</summary>
    ...
    /// <summary>
    /// One writable field: how to read it out of the entity, how to write it back, and how to turn
    /// a JSON value into something assignable.
    /// </summary>
        ...
        where TEnum : struct, System.Enum
    {
        ...
        // The numeric form is accepted because a client generated from the OpenAPI document may
        // send it.
