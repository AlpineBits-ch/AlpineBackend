...
/// <summary>
/// Covers QuestEndpoints - a static, Wolverine-attributed, read-only HTTP surface for the
/// companion website. Called directly as plain C# methods, per the repo's Wolverine HTTP testing
/// convention (see KingOfTheHillEndpointsTests). No SaveChangesAsync is needed on the endpoint's
/// own behalf; only the test fixture setup saves so seeded rows are visible to the query.
/// </summary>
[TestFixture]
