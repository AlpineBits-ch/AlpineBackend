...
// Class-level [Authorize] so GetEmojis is covered too - it resolves the caller and checks
// ViewChannel, but Guild registers no fallback policy, so it was otherwise anonymously reachable.
[Authorize]
[ApiController]
