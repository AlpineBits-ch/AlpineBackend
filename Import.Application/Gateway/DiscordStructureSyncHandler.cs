...
/// <summary>
/// Applies one already-parsed Discord Gateway dispatch (CHANNEL_*/GUILD_ROLE_*) to whichever
/// Echo guild is linked to that Discord guild. Invoked directly by DiscordGatewayClient (not a
/// Wolverine message handler - there's no inbound HTTP/bus envelope here, just a raw dispatch
/// off a long-lived socket), so it commits its own MicroserviceContext changes rather than
/// relying on Wolverine's DbContext middleware.
/// </summary>
