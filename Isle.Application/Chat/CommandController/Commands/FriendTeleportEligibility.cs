...
/// <summary>
/// Shared gate for friend teleports: the acting player must be a fresh spawn — at or under
/// <see cref="FriendRequest.MaxGrowthForTeleport"/> growth and within <see cref="FriendRequest.SpawnWindow"/>
/// of spawning. Applied to the sender when a request is made and to the acceptee when it is accepted
