...
/// <c>AuthenticatorTokenProvider&lt;TUser&gt;</c> (HMAC-SHA1, 30s time step, 6 digits, no
/// modifier - the same parameters MfaEndpoint.BuildOtpAuthUri advertises: algorithm=SHA1,
/// digits=6, period=30). Lets MfaFlowTests generate real authenticator-app codes against the
/// Base32 secret Identity returns from <c>/mfa/enroll</c>, without pulling in an external
/// OtpNet-equivalent package for one test.
/// </summary>
