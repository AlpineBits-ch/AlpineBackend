...
/// materialization command and publishes it - this is what
/// Guild/Messaging/Social.Application's own materialization handlers (Phase 3) subscribe to.
/// Previously this dispatch didn't exist: FireEventAsync only published
/// FederationInboundEventReady, which had no subscriber anywhere, so a successfully-received and
/// DAG-resolved event was recorded and then silently dropped.
/// </summary>
