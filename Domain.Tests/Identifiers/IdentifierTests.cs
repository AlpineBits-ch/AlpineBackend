...
///
/// <see cref="Ids_sort_lexicographically_by_mint_time"/> is the load-bearing one: the previous
/// encoding was uppercase, unique and timestamp-prefixed while being silently unsortable, which
/// nothing catches until something tries to use an id as a cursor.
/// </summary>
[TestFixture]
public class IdentifierTests
{
    ...
    public void Ids_sort_lexicographically_by_mint_time()
    {
        ...
        // clustering key perform. A culture-sensitive sort could pass here and still order rows
