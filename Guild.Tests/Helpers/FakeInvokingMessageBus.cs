...
public class FakeInvokingMessageBus : IMessageBus
{
    ...
    /// <summary>Drops every canned response, so the next InvokeAsync throws. How a test says "the
    /// other service is unreachable" without needing a second fake.</summary>
