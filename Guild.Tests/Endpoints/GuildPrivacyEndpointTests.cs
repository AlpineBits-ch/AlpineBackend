...
/// T2-14).
///
/// <para>Like the notification settings it is modelled on, every route acts on the caller alone, so
/// what is worth pinning is the upsert semantics, the membership requirement, and - the part that
/// is genuinely a privacy control rather than a preference - what a guild with no stored row
/// resolves to.</para>
/// </summary>
[TestFixture]
