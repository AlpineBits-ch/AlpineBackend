...
/// <summary>
/// Computes RFC 6238 TOTP codes from a raw Base32 authenticator secret so tests can produce a code
/// that ASP.NET Core Identity's AuthenticatorTokenProvider will actually accept.
/// </summary>
