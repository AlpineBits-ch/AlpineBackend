...
/// <summary>T1-9: what <see cref="ApplicationUser.Tombstone"/> leaves behind.</summary>
[TestFixture]
public class TombstoneAgeDataTests
{
    ...
    {
        // CreateBot leaves AgeVerification with no birth date at all.
    ...
    public void Tombstone_CalledTwice_DoesNotOverwriteTheRetainedBoolean()
    {
        ...
        // Redelivery of PurgeUserDataCommand.
        user.Tombstone();
