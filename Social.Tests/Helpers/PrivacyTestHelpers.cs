...
internal static class PrivacyTestHelpers
{
    ...
    /// <summary>The real bus-backed resolver over <see cref="FakeMessageBus"/>. With no registered
    /// answer the bus throws, which is exactly the Guild outage the resolver must absorb.</summary>
    ...
    /// <summary>The real bus-backed Identity resolver over <see cref="FakeMessageBus"/>. With no
    /// registered answer the bus throws, which is the Identity outage the resolver must absorb.</summary>
