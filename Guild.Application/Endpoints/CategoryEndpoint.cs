...
public class CategoryEndpoint
{
    ...
    // with type:4, and Bots.Application's dispatch/DiscordChannelType already expect that (see the
    // Discord import sync handler's "Categories are just type:4 channels" comment).
