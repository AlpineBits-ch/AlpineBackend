...
/// <summary>
/// Resolves a King of the Hill match: persists the run, pays out, announces, and tears down the Redis
/// state. The non-bounty-hunt counterpart to <c>QuestCompletionService</c> — same shared-teardown shape,
/// same rank-tiering rule.
/// </summary>
