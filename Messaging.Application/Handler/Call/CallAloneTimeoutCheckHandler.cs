...
public class CallAloneTimeoutCheckHandler
{
        ...
        IDistributedCache cache, LockedJsonCacheStore callStore, IMessageBus bus)
    {
        ...
        // fires. EndIfStillAlone re-validates AloneSince from inside the mutate delegate so a
        // stale scheduled check can't wrongly end a call that already moved on.
