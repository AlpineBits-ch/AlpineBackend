...
/// <summary>
/// Published whenever a King of the Hill match starts. Nothing subscribes yet — mirrors
/// <c>Isle.Contracts.Events.Quest.QuestEvents</c>: the seam a companion website (and any SignalR push)
/// will hang off, so the KOTH services never need to know a web front end exists.
/// </summary>
