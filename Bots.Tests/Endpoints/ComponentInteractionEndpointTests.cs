...
/// The load-bearing behaviour here is validation: a client must not be able to name a custom_id
/// the message does not carry, and must not be able to reach another user's ephemeral message.
/// </summary>
[TestFixture]
