...
internal static class TypeGraph
{
    ...
    /// <c>ICollection&lt;DamageMedia&gt;</c> yields DamageMedia, <c>Damage?</c> yields Damage,
    /// <c>Dictionary&lt;string, Offer&gt;[]</c> yields string and Offer. Serializers write through
    /// all of those, so all of them count as "exposed".
    /// </summary>
