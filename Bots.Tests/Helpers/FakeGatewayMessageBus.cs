...
/// <summary>Hand-rolled no-op IMessageBus for Gateway/Handlers/*.cs and BotCommandEndpoint tests -
/// mirrors this repo's no-mocking-framework convention (Guild.Tests/Helpers/FakeMessageBus.cs).
/// Only the InvokeAsync overloads those classes actually call (GetGuildMemberResponse,
/// GetUserByIdResponse, HasUserPermissionToChannelResponse) return canned data; everything else
/// throws since nothing in this suite should reach it.</summary>
