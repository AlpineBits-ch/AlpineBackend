...
/// <summary>
/// Builds the READY + GUILD_CREATE burst a bot receives right after a successful IDENTIFY. The
/// bot's own identity and guild list come from Bots.Application's own database (zero bus
/// round-trips - BotInstallations already has exactly "which guilds is this bot in"); each
/// guild's channels/roles/self-member come from one composite cross-service query per guild,
/// parallelized so a bot in many guilds doesn't pay for them serially.
/// </summary>
