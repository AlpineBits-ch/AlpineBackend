...
/// against an already-deployed instance instead. Trigger it explicitly once you have real bot
...
/// BOTS_E2E_BASE_URL / the file's "baseUrl" default to https://api.venta.gg. The bot doesn't need
/// to be installed in any guild for this to pass - it only proves the wire handshake (HELLO/
/// IDENTIFY/READY/heartbeat) actually works against the live deployment. If it IS installed
/// somewhere, a GUILD_CREATE is also expected to follow, but "not installed anywhere" is a valid
/// outcome too, not a failure. See also Bots.Tests/e2e-discordjs/ for the same check driven by
/// the real discord.js library instead of this hand-rolled ClientWebSocket client.
/// </summary>
[TestFixture]
