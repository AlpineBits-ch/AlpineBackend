...
/// or an in-game name. Steam id and friendly id are unique; an in-game name may collide, in which
/// case resolution is <see cref="ResolveOutcome.Ambiguous"/> and the caller should ask for a
/// friendly id instead.
/// </summary>
