...
///
/// The reported bug was "the message update notification drops the embed", so what is pinned here
/// is that the embeds reach both audiences - a fix that only kept the embed in storage would still
/// have left every open client rendering the edit without its card.
/// </summary>
[TestFixture]
