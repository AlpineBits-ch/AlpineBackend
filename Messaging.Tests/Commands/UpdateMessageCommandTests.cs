...
public class UpdateMessageCommandTests
{
    ...
    // ══════════════════════════════════════════════════════════════════════
    // Patch semantics: null leaves the field alone, an empty array clears it
    //
    // The reported bug was "editing a message drops its embed from the update notification". It
    // was worse than that: EmbedsJson was assigned unconditionally, so an ordinary text edit -
    // which carries no embeds - nulled the stored column. The notification was merely reporting
    // the loss accurately.
    // ══════════════════════════════════════════════════════════════════════
