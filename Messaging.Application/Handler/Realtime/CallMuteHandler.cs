...
public class CallMuteHandler
{
    public static async Task Handle(CallMuteCommand cmd, IDistributedCache cache, IHubContext<EchoRealtimeHub> hub)
    {
        ...
        await hub.Clients.Users(otherIds).SendAsync("call.MuteChanged",
            new { userId = cmd.UserId, isMuted = cmd.IsMuted });
    }
}
