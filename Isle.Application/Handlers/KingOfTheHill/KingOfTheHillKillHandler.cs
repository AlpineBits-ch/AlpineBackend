...
/// <summary>
/// Pays out for killing whoever currently holds the hill alone. Runs on the same resolved
/// <see cref="PlayerKillEvent"/> <c>BountyKillHandler</c> does — no location check on the killer, only
/// on the victim: if they were the credited sole holder at the moment they died, taking them down is
/// the reward-worthy act regardless of where the kill happened from.
/// </summary>
