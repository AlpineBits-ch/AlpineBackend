...
public class MicroserviceContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<GuildDirectMessagePreference>(preferenceBuilder =>
        {
            ...
            // aggregate widens that materialization graph (same reasoning as ForumTag). Cascade
            // still applies, so deleting a guild drops the preferences that referenced it.
