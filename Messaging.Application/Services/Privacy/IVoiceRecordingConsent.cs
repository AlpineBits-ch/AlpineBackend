...
public static class VoiceRecordingRefusal
{
    ...
    /// <summary>At least one participant has not granted consent for this session.</summary>
...
/// <summary>Where a per-session, per-participant recording grant is looked up.</summary>
...
/// <summary>The registered default: nobody has ever granted anything.</summary>
...
/// <summary>The shipped <see cref="IVoiceRecordingConsent"/>.</summary>
