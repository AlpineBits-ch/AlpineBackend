...
///
/// <para>The rule is one line, which is exactly why it needs pinning: it was previously implemented
/// nowhere and open-coded in two places, and both got it wrong. What matters is that Hidden never
/// survives a third-party projection, that nothing else is altered on the way through, and that an
/// unrecognised value degrades towards Offline rather than being passed along.</para>
/// </summary>
[TestFixture]
