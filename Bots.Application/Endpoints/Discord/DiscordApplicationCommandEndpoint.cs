...
/// <summary>
/// Discord's real application-command registration surface. "application.id" throughout is the
/// bot's own BotUserId (the same id-collapsing trick used everywhere else in this compat layer -
/// see BotApplication.cs's remarks) - a bot can only ever manage its own commands, enforced by
/// matching the route param against the caller's JWT subject rather than any separate ACL.
/// </summary>
[Authorize]
