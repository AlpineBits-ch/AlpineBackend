...
public class MetadataParserTests
{
    ...
    {
        // A page can claim any canonical URL it likes. Believing one that points elsewhere would
        // produce a card whose title links to a site the content did not come from - which is a
    ...
    {
        // Real-world markup: unclosed tags, unquoted attributes, junk. A regex-based extractor
        // falls apart here, which is why this uses a real parser.
        var meta = await ParseAsync("""
