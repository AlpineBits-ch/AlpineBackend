...
/// <summary>
/// Every public path is a gateway path, and most gateway routes strip the service segment:
...
public class GatewayRouteContractTests
{
    ...
    /// <summary>The attributes that declare an absolute route on our endpoints.</summary>
    ...
    /// <summary>The service segments the gateway removes on the way through.</summary>
