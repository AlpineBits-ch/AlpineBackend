...
/// <summary>The SSRF guard.</summary>
public class OutboundAddressGuardTests
{
    ...
    {
        // ::ffff:169.254.169.254 is the metadata endpoint wearing an IPv6 costume.
        Assert.Multiple(() =>
        {
    ...
    {
        // Documents the division of labour deliberately: a name cannot be judged up front, because
        // what it resolves to now is not what it will resolve to when the socket opens.
