...
public class CrossServiceFlowTests
{
    ...
    public async Task RegisterUser_ProfileIsMaterializedInSocial_ViaRealRabbitMqEvent()
    {
        ...
        // cover an address that already has an account (docs/specs/registration-contract-change.md).
        // Signing in is how a client finds out its own id now, and it doubles as proof the account
        // this test is about to look for in Social was really created.
