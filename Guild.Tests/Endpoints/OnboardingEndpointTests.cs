...
public class OnboardingEndpointTests
{
    ...
    // ══════════════════════════════════════════════════════════════════════
    // Validation and the disable path
    // ══════════════════════════════════════════════════════════════════════
    ...
    // ══════════════════════════════════════════════════════════════════════
    // Prompts — config reconciliation, role safety, and applying answers
    //
    // The manager role sits at position 10 so it outranks the grantable roles
    // seeded at position 0 - CanManageRoleAsync is a strict "outranks" check,
    // so same-position roles could not be wired up.
    // ══════════════════════════════════════════════════════════════════════
    ...
    {
        // The moderator handed this member the same role by hand. Deselecting the option that also
        // grants it must not strip it - onboarding may only take back what onboarding gave.
        var (promptId, optionId, member) = await SeedAnswerableGuild();
