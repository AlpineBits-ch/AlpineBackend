...
/// <summary>Covers Isle's copy of the §1.4 privacy cache.</summary>
[TestFixture]
public class PrivacySettingsCacheTests
{
    ...
    {
        // A failed eviction means the old value survives until the refresh window elapses.
    ...
    {
        // Past the refresh window, so the cache re-asks - and the re-ask fails.
        var cache = new FakeDistributedCache();
