...
namespace Guild.Persistence.Migrations
{
    ...
    [Migration("20260505150049_AddGuildStuff")]
    partial class AddGuildStuff
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Guild.Domain.Aggregates.Guild", b =>
                {
                    ...
                    b.Property<string>("SystemChannelId1")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("system_channel_id1");
                    ...
                    b.HasIndex("SystemChannelId1")
                        .HasDatabaseName("ix_guilds_system_channel_id1");
            ...
            modelBuilder.Entity("Guild.Domain.Aggregates.Guild", b =>
                {
                    b.HasOne("Guild.Domain.Aggregates.Channel", "SystemChannel")
                        .WithMany()
                        .HasForeignKey("SystemChannelId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_guilds_channels_system_channel_id1");
