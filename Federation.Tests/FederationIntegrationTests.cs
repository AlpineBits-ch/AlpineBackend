...
/// <summary>
/// End-to-end federation tests: Instance A (sender) posts signed events to
/// Instance B (in-process TestServer). The full validation pipeline runs:
/// host lookup → status check → signature verification → HandleInboundEventAsync.
/// </summary>
[TestFixture]
