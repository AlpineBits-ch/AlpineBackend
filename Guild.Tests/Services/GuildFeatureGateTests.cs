...
///
/// The case worth reading first is <see cref="GuildOwner_CannotUseDisabledFeature"/>. Everything
/// else in this service short-circuits to "yes" for the owner, and Superadmin makes
/// PermissionExtensions.HasPermission return true unconditionally - so if the gate were folded
/// into the permission bitmask instead of sitting in front of it, an owner would walk straight
/// through a disabled module. A feature being off is a product state, not an authorization level.
/// </summary>
[TestFixture]
