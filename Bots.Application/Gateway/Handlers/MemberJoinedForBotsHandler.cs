...
public class MemberJoinedForBotsHandler
{
    public static async Task Handle(MemberJoinedForBots evt, MicroserviceContext ctx, GatewayConnectionRegistry registry, IMessageBus bus)
    {
        ...
        var payload = new GuildMemberAddPayload
        {
            GuildId = evt.GuildId,
        ...
        {
            await registry.PublishAsync(botUserId, "GUILD_MEMBER_ADD", payload);
        }
    }
}
