...
/// <summary>
/// Turns a chosen <see cref="GameModeDefinition"/> into a live, announced match. Shared by the
/// background tick and <c>!kothadmin start</c> so a forced start behaves exactly like an automatic one
/// — the same split <c>QuestSpawner</c> keeps for quests.
/// </summary>
