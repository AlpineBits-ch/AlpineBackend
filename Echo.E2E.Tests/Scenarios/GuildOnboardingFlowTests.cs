...
/// participation-restricted until they accept, accepting applies the grants, and Channels &amp; Roles
/// takes them back on deselect.
///
/// The permission stripping is what makes this worth an E2E rather than a unit test - it runs
/// through the real Redis-backed permission cache, so a stale cache after accept would show up here
/// and nowhere else.
/// </summary>
[TestFixture]
[Category("E2E")]
