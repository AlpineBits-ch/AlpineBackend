...
public class HouseholdDomainTests
{
    ...
    /// <summary>The idempotency guard. Without it, every decrement below the threshold appends
    /// another duplicate line and the shopping list becomes noise within a week.</summary>
    [Test]
