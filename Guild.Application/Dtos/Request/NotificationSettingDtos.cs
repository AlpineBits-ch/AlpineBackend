...
public class UpdateGuildNotificationSettingDto
{
    ...
    /// <summary>Minutes to mute for. 0 or negative clears the mute; null leaves it untouched;
    /// <see cref="MuteForever"/> outranks both. Expressed as a duration rather than an absolute
    /// timestamp so the client never has to reason about clock skew against the server.</summary>
