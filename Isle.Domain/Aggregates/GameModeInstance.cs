...
public class GameModeInstance : Aggregate<GameModeInstance>, IPrefixedEntity
{
    ...
    /// <summary>
    /// Reconstructs a match that was already running when the process last stopped, from the
    /// durable marker in <c>KingOfTheHillMatchStateStore</c> (or any future mode's equivalent).
    /// </summary>
