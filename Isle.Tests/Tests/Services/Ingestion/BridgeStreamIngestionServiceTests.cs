...
/// requiring a real multi-second reconnect delay to elapse. Per-message translation logic
/// (PublishAsync/IsRelevant business rules) is covered per concrete service instead - this file is
/// only about the loop itself, exercised through a minimal test-only subclass since the base class
/// is abstract.
/// </summary>
[TestFixture]
