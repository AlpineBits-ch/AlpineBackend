...
/// <summary>
/// Test double for <see cref="IBotChannelVisibility"/>. Defaults to "every installed bot can see
/// the channel", which keeps the existing dispatch tests focused on payload shape; tests that care
/// about the permission filter itself pass an explicit allow-list (or a denied channel).
/// </summary>
