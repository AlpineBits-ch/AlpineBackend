...
namespace Messaging.Infrastructure.Migrations
{
    ...
    [Migration("20260820141139_AddSceneCharacterMessageTypes")]
    partial class AddSceneCharacterMessageTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "message_type", new[] { "call_ended", "call_missed", "dice_roll", "group_icon_changed", "group_name_changed", "guild_member_join", "guild_member_leave", "invite", "message", "scene_character_joined", "scene_character_left", "voice_channel_invite" });
            ...
            modelBuilder.Entity("Messaging.Domain.Aggregates.Conversation", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("IconUpdatedAt")
                        .HasColumnType("timestamp with time zone")
            ...
            modelBuilder.Entity("Messaging.Domain.Entities.MlsGroupGeneration", b =>
                {
                    ...
                    b.Property<string>("ActivatedByDeviceId")
                        .HasColumnType("text")
                        .HasColumnName("activated_by_device_id");
