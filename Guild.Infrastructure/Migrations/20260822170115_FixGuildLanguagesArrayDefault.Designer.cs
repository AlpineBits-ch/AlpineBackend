...
namespace Guild.Persistence.Migrations
{
    ...
    [Migration("20260822170115_FixGuildLanguagesArrayDefault")]
    partial class FixGuildLanguagesArrayDefault
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "scene_join_policy", new[] { "ask", "open" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "scene_join_request_status", new[] { "approved", "denied", "pending", "withdrawn" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "scene_status", new[] { "active", "concluded", "open", "paused" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "scene_visibility", new[] { "cast", "everyone" });
            ...
            modelBuilder.Entity("Guild.Domain.Aggregates.Guild", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("OtherLanguages")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text[]")
            ...
            modelBuilder.Entity("Guild.Domain.Entity.InboxTaskDismissal", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Guild.Domain.Entity.SceneFolder", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_scene_folders");

                    b.HasIndex("ParentFolderId")
                        .HasDatabaseName("ix_scene_folders_parent_folder_id");

                    b.HasIndex("GuildId", "Position")
                        .HasDatabaseName("ix_scene_folders_guild_id_position");

                    b.ToTable("scene_folders", (string)null);
                });

            modelBuilder.Entity("Guild.Domain.Entity.SceneJoinRequest", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("SceneChannelId")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("scene_channel_id");

                    b.Property<SceneJoinRequestStatus>("Status")
                        .HasColumnType("scene_join_request_status")
                        .HasColumnName("status");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_scene_join_requests");

                    b.HasIndex("GuildId", "Status")
                        .HasDatabaseName("ix_scene_join_requests_guild_id_status");

                    b.HasIndex("SceneChannelId", "PersonaId")
                        .IsUnique()
                        .HasDatabaseName("ix_scene_join_requests_scene_channel_id_persona_id")
                        .HasFilter("status = 'pending'");

                    b.HasIndex("SceneChannelId", "Status")
                        .HasDatabaseName("ix_scene_join_requests_scene_channel_id_status");

                    b.ToTable("scene_join_requests", (string)null);
                });
            ...
            modelBuilder.Entity("Guild.Domain.Entity.SceneState", b =>
                {
                    ...
                    b.Property<SceneJoinPolicy>("JoinPolicy")
                        .HasColumnType("scene_join_policy")
                    ...
                    b.Property<SceneVisibility>("Visibility")
                        .HasColumnType("scene_visibility")
                        .HasColumnName("visibility");
                    ...
                    b.HasIndex("FolderId")
                        .HasDatabaseName("ix_scene_states_folder_id");

                    b.HasIndex("OocThreadId")
                        .HasDatabaseName("ix_scene_states_ooc_thread_id");

                    b.HasIndex("GuildId", "FolderId")
                        .HasDatabaseName("ix_scene_states_guild_id_folder_id");
            ...
            modelBuilder.Entity("Guild.Domain.Entity.SceneTag", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_scene_tags");

                    b.HasIndex("GuildId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_scene_tags_guild_id_name");

                    b.HasIndex("GuildId", "Position")
                        .HasDatabaseName("ix_scene_tags_guild_id_position");

                    b.ToTable("scene_tags", (string)null);
                });

            modelBuilder.Entity("Guild.Domain.Entity.SceneTagAssignment", b =>
                {
                    b.Property<string>("SceneChannelId")
                        .HasColumnType("text")
                        .HasColumnName("scene_channel_id");
                    ...
                    b.HasKey("SceneChannelId", "TagId")
                        .HasName("pk_scene_tag_assignments");

                    b.HasIndex("TagId")
                        .HasDatabaseName("ix_scene_tag_assignments_tag_id");

                    b.ToTable("scene_tag_assignments", (string)null);
                });
            ...
            modelBuilder.Entity("Guild.Domain.Entity.SceneFolder", b =>
                {
                    b.HasOne("Guild.Domain.Aggregates.Guild", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_scene_folders_guilds_guild_id");

                    b.HasOne("Guild.Domain.Entity.SceneFolder", null)
                        .WithMany()
                        .HasForeignKey("ParentFolderId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_scene_folders_scene_folders_parent_folder_id");
                });
            ...
            modelBuilder.Entity("Guild.Domain.Entity.SceneJoinRequest", b =>
                {
                    b.HasOne("Guild.Domain.Aggregates.Guild", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_scene_join_requests_guilds_guild_id");

                    b.HasOne("Guild.Domain.Aggregates.Channel", null)
                        .WithMany()
                        .HasForeignKey("SceneChannelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_scene_join_requests_channels_scene_channel_id");
                });
            ...
            modelBuilder.Entity("Guild.Domain.Entity.SceneState", b =>
                {
                    ...
                    b.HasOne("Guild.Domain.Entity.SceneFolder", null)
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_scene_states_scene_folders_folder_id");
            ...
            modelBuilder.Entity("Guild.Domain.Entity.SceneTag", b =>
                {
                    b.HasOne("Guild.Domain.Aggregates.Guild", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_scene_tags_guilds_guild_id");
                });
            ...
            modelBuilder.Entity("Guild.Domain.Entity.SceneTagAssignment", b =>
                {
                    b.HasOne("Guild.Domain.Aggregates.Channel", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_scene_tag_assignments_channels_scene_channel_id");

                    b.HasOne("Guild.Domain.Entity.SceneTag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_scene_tag_assignments_scene_tags_tag_id");
                });
