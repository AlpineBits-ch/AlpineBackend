...
/// Unlike Create(CreateUserParams), it takes a caller-supplied id (so the Bots service's
/// create-application flow is idempotent under retry) and skips the human-only
/// email/age-verification machinery entirely.
/// </summary>
