...
/// <summary>The invite splash - what someone sees while deciding whether to join. Reading it
/// requires membership; the pre-join case is served by the invite preview endpoint
/// (GET /invites/code/{code}), which embeds the same payload.</summary>
[Authorize]
