...
///
/// Unlike FakeHttpClientFactory, this one answers requests. CreateSession really does call
/// Cloudflare, so a client that never responds would hang the controller under test.
/// </summary>
