...
/// <summary>
/// Reading and replacing a guild's onboarding config. Shared by the first-party endpoint and the
/// Discord-compatible bot surface so the two can never drift - in particular so a bot cannot
/// configure a prompt the UI would have rejected.
/// </summary>
    ...
    AuditLogService auditLog)
{
    ...
    /// <summary>Whole-document replace. Returns the validation failure, or the stored config on
    /// success. Does not commit - Wolverine's middleware does.</summary>
