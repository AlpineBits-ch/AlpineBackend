...
{
    // Deliberately unfiltered: the channel row is already gone, so a visibility check would resolve
    // to "deny everyone" and no bot would ever learn the channel was deleted.
