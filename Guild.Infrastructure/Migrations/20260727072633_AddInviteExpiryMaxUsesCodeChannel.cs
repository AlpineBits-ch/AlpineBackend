...
namespace Guild.Persistence.Migrations
{
    ...
    public partial class AddInviteExpiryMaxUsesCodeChannel : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Every pre-existing row got the same "" default for `code` above, which would
            // collide against the unique index created below as soon as a second invite row
            // exists. Backfill each row with a distinct code first.
