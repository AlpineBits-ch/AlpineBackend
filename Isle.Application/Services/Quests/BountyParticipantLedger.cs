...
public sealed class BountyParticipantLedger(IConnectionMultiplexer redis, ILogger<BountyParticipantLedger> logger)
{
    ...
    /// <summary>
    /// Reads a <c>HINCRBYFLOAT</c> total. Invariant culture explicitly: Redis always writes the decimal
    /// point, and a host running under a comma-decimal culture would otherwise read <c>"1500.5"</c> as
    /// fifteen thousand or fail outright, silently mis-ranking or dropping a participant.
    /// </summary>
