...
/// <summary>The partial-update applier behind <c>PATCH api/v1/privacy-settings</c>.</summary>
[TestFixture]
public class PrivacySettingsPatchTests
{
    ...
    {
        // The caller uses ChangedFields to decide whether to bump the version, write an audit row
        // and publish a cache-eviction event.
    ...
    {
        // The case that makes the unknown-field rule worth having.
