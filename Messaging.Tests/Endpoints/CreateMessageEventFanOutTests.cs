...
/// <summary>
/// Regression cover for the duplicate-notification bug: every message sent through POST
/// /api/v1/messaging notified twice - twice on the phone, and twice in the desktop client.
/// </summary>
[TestFixture]
