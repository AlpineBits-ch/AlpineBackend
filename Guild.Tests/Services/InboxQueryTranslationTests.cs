...
///
/// <para>See <see cref="PostgresGuildContext"/> for why these are separate from the behavioural
/// tests and why they need no database.</para>
/// </summary>
[TestFixture]
public class InboxQueryTranslationTests
{
    ...
    /// <summary>The ORDER BY must land on the source columns, not on the select list. If a future
    /// edit moves it back after the projection this assertion goes first, and with a clearer
    /// message than a translation exception.</summary>
    [Test]
