...
///
/// <para>Failures are logged and the loop continues. A sweep that dies on one tick and never runs
/// again is worse than one that retries in six hours, because the symptom - archives of complete
/// personal data quietly outliving their seven days in a bucket - is invisible until somebody goes
/// looking.</para>
/// </summary>
