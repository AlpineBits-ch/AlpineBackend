...
/// HELLO/IDENTIFY/heartbeat/receive-loop logic in a unit test without a real socket or an
/// ASP.NET Core TestServer. Inbound frames (what a client would send) are queued with
/// <see cref="EnqueueText"/>/<see cref="EnqueueClose"/> before calling GatewayConnection.RunAsync;
/// outbound frames (what the server sent back) land in <see cref="SentTextMessages"/>.
/// </summary>
